...
public class CouponAdapter extends ArrayAdapter<Coupon> {
    ...
    public CouponAdapter(@NonNull Context context, int resource, List<Coupon> arrCoupon) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        viewHolder.categoryAndremain.setText(coupon.getCategory() + " (Remain: " + coupon.getRemain() + ")");
